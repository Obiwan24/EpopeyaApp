 ...
 *
 * 1) crearUsuario() ahora CIFRA la contraseña con BCrypt antes de guardarla
 ...
 *
 * 2) Se añaden obtenerUsuarioActual/actualizarPerfil/cambiarPassword, usados
...
public class UsuarioService {
    ...
    public Usuario crearUsuario(Usuario usuario) {
        if (usuarioRepository.findByUsername(usuario.getUsername()).isPresent()) {
            throw new RuntimeException("Ya existe un jugador con el nombre de usuario '" + usuario.getUsername() + "'.");
        }
